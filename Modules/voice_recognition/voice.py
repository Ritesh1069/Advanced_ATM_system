...
def determine_action(text):
    ...
    debit_keywords = ["debit", "withdraw", "withdrawal", "take out", "remove", "spend", "reduce", "pay", "charge", "deduct", "transfer out", "cash out","want to send","make a transaction to pay","have to take"]
